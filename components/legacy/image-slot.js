"use client";
// image-slot.js — user-fillable <image-slot> custom element.
// Guarded for SSR: the class definition touches HTMLElement/document, which
// don't exist during Next.js server rendering, so it only registers in the
// browser. Outside the "omelette" design-tool runtime this behaves read-only
// (no window.omelette.writeFile bridge), same as the original standalone demo.
